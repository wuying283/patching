...
- v0.3 -- PySide6 / shiboken6 UI migration for IDA 9
...
This plugin requires IDA 9.x, Python 3, and the PySide6 / shiboken6 Qt bindings bundled with IDA. It supports Windows, Linux, and macOS.
...
Copy to `IDAProRoot/plugins` to install.

The Qt UI layer now targets PySide6. Older PyQt5 / PySide5 based IDA installations are not supported by this branch.
...
See [Dev-guide.md](Dev-guide.md) for the project layout, PySide6 migration notes, and local validation checklist.
